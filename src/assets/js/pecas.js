class Pecas {
  ...
  createPecas () {
    const newTokenElement = document.createElement('div')
    ...
    const left = this.player.id == 1 ? 3 : 23 + document.getElementById('tabuleiro').offsetWidth / document.documentElement.clientHeight * 100
